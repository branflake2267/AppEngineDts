...
public class TransferDataTest_ArcBees {
  ...
  public void testSetEntitiesProperties() {
    ...
    String optionsPath = "/Users/branflake2267/Documents/workspace/AppEngineDts/parameters/test/testentities_arc.properties";
    ...
    if (entities.contains("Show") == false) {
      fail("no cedars");
    }

    if (entities.contains("Profile") == false) {
      fail("no people");
    }
